...
docker run --network %DOCKER_NETWORK% --env-file %ENV_FILE% bde2020/hadoop-base:%DOCKER_IMAGE_VERSION% hdfs dfs -copyFromLocal -f /opt/hadoop-3.2.1/README.txt /input/
